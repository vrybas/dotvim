...
hi StatusLine ctermbg=DarkBlue ctermfg=fg cterm=NONE guibg=#666666 guifg=bg gui=none
if has("windows")
...
hi Comment ctermbg=bg ctermfg=Green guibg=bg guifg=#999999 gui=italic
hi link SpecialComment Comment

hi Character ctermbg=bg ctermfg=Red guibg=bg guifg=#cc0000 gui=none
hi String ctermbg=bg ctermfg=Red guibg=bg guifg=#990000 gui=none " 'No mutants allowed'
hi Constant ctermbg=bg ctermfg=Yellow guibg=bg guifg=#003366 gui=none " :json :metods true
hi link Number Constant
hi link Float Constant
hi link Boolean Constant

hi Identifier ctermbg=bg ctermfg=Magenta guibg=bg guifg=#333333 gui=bold " index @document respond_to render
hi link Function Identifier

hi Statement ctermbg=bg ctermfg=Blue guibg=bg guifg=#006600 gui=bold " if else return unless
...
hi Type ctermbg=bg ctermfg=Blue guibg=bg guifg=#000000 gui=italic " Digest::MD5
hi link StorageClass Type
hi link Structure Type
hi link Typedef Type

hi PreProc ctermbg=bg ctermfg=DarkYellow guibg=bg guifg=#3333ff gui=none " class def...end
hi PreCondit ctermbg=bg ctermfg=Yellow guibg=bg guifg=#999900 gui=none
hi link Include PreProc
hi link Define PreProc
hi link Macro PreProc

hi Special ctermbg=bg ctermfg=Cyan guibg=bg guifg=#FF0000 gui=none " regular expressions
